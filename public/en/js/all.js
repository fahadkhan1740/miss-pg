...
const intvl = setInterval(function() {
    ...
    countdown.innerHTML = `
        ...
        <div><span class="break">:</span></div>
        <div class="countdown__item"><h2 class="countdown__lg-text">${mins}  </h2><span class="countdown__sm-text">Min</span></div>
        <div><span class="break">:</span></div>
